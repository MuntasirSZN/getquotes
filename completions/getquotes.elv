...
set edit:completion:arg-completer[getquotes] = {|@words|
    ...
    var completions = [
        &'getquotes'= {
            ...
            cand -i 'Initialize quote cache (optionally specify comma-separated authors)'
            cand --init-cache 'Initialize quote cache (optionally specify comma-separated authors)'
