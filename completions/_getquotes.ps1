...
Register-ArgumentCompleter -Native -CommandName 'getquotes' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'getquotes' {
            ...
            [CompletionResult]::new('-i', '-i', [CompletionResultType]::ParameterName, 'Initialize quote cache (optionally specify comma-separated authors)')
            [CompletionResult]::new('--init-cache', '--init-cache', [CompletionResultType]::ParameterName, 'Initialize quote cache (optionally specify comma-separated authors)')
