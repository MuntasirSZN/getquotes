...
## [v0.7.2](https://github.com/MuntasirSZN/getquotes/compare/v0.7.1...v0.7.2) (2026-06-08)

### 🐞 Bug Fixes

- no random, now all at once init-cache


<a name="v0.7.1"></a>

## [v0.7.1](https://github.com/MuntasirSZN/getquotes/compare/v0.7.0...v0.7.1) (2026-06-01)

### ✨ Features

- feat: remove unnecessary bin
...
## [v0.7.0](https://github.com/MuntasirSZN/getquotes/compare/v0.6.1...v0.7.0) (2026-05-30)
...
- feat: All packages are in packages dir
- better changelog
...
- everything
- **tests:** trying
- fix(logger): Now works
- **tests:** Checking
- **tests:** Final fix
- sqlite
- my name in cargo.toml
- fix(workflow): Now better
- fix(workflow): Now better
